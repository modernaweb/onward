...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Onward_Custom_Control extends WP_Customize_Control {
		protected function get_onward_resource_url() {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Custom_Section extends WP_Customize_Section {
		protected function get_onward_resource_url() {
			if( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Onward_Image_Checkbox_Custom_Control extends Onward_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Onward_Text_Radio_Button_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Image_Radio_Button_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Single_Accordion_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'onward-custom-controls-js', $this->get_onward_resource_url() . 'js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Simple_Notice_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Slider_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'onward-custom-controls-js', $this->get_onward_resource_url() . 'js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Toggle_Switch_Custom_control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Sortable_Repeater_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Dropdown_Select2_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'onward-select2-js', $this->get_onward_resource_url() . 'js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'onward-custom-controls-js', $this->get_onward_resource_url() . 'js/customizer.js', array( 'onward-select2-js' ), '1.0', true );
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'onward-select2-css', $this->get_onward_resource_url() . 'css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Dropdown_Posts_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_TinyMCE_Custom_control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Google_Font_Select_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->onward_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->onward_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'onward' ) ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'onward' ) ?> <italic><?php esc_html_e( 'italic text', 'onward' ) ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'onward' ) ?> <strong><?php esc_html_e( 'bold text', 'onward' ) ?></strong></div>
					<div class="weight-style">
		 ...
		 */
		public function onward_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function onward_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_onward_resource_url() . 'inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = $this->get_onward_resource_url() . 'inc/google-fonts-popularity.json';
			}
	 ...
	 */
	class Onward_Customize_Alpha_Color_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'onward-custom-controls-js', $this->get_onward_resource_url() . 'js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class Onward_Alpha_Color_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_onward_resource_url() . 'js/wp-color-picker-alpha.js', array( 'wp-color-picker' ), '1.0', true );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Onward_Pill_Checkbox_Custom_Control extends Onward_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'onward-custom-controls-js', $this->get_onward_resource_url() . 'js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'onward-custom-controls-css', $this->get_onward_resource_url() . 'css/onward-customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class Onward_Upsell_Section extends Onward_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'onward-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="onward_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'onward_url_sanitization' ) ) {
		function onward_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'onward_switch_sanitization' ) ) {
		function onward_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'onward_radio_sanitization' ) ) {
		function onward_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'onward_sanitize_integer' ) ) {
		function onward_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'onward_text_sanitization' ) ) {
		function onward_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'onward_array_sanitization' ) ) {
		function onward_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'onward_hex_rgba_sanitization' ) ) {
		function onward_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgba' ) ) {
				...
				$input = 'rgba(' . onward_in_range( $red, 0, 255 ) . ',' . onward_in_range( $green, 0, 255 ) . ',' . onward_in_range( $blue, 0, 255 ) . ',' . onward_in_range( $alpha, 0, 1 ) . ')';
			}
			return $input;
		}
	}
	 ...
	 */
	if ( ! function_exists( 'onward_in_range' ) ) {
		function onward_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'onward_google_font_sanitization' ) ) {
		function onward_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'onward_date_time_sanitization' ) ) {
		function onward_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'onward_range_sanitization' ) ) {
		function onward_range_sanitization( $input, $setting ) {
			...
			return onward_in_range( $number, $min, $max );
		}
	}
